...
<html <?php language_attributes(); ?> class="no-js">
	<head>
        ...
        <link href="<?php echo get_template_directory_uri(); ?>/img/icons/kss_favicon.png" rel="shortcut icon">
        <link href="<?php echo get_template_directory_uri(); ?>/img/icons/kss_favicon.png" rel="apple-touch-icon-precomposed">
		    ...
		    <div class="container pl-2 pl-sm-0 pr-2 pr-sm-0">
		        <nav class="navbar navbar-expand-lg better-bootstrap-nav-left pl-1 pr-1 pb-0 pt-0">
		            ...
		            <a href="/" class="header-logo">
		              <img src="<?php echo get_template_directory_uri(); ?>/img/logo-kss.png" class=" img-fluid m-0 kss-logo" width="180px">
		            </a>
		            ...
		            <div class="megamenu">
		              ...
		              <div class="d-flex d-lg-none justify-content-between align-items-center border-bottom border-cancel header-close-trigger">
		                <a href="/">
		                  <img src="<?php echo get_template_directory_uri(); ?>/img/logo-kss.png" class=" img-fluid m-3 d-block d-lg-none" width="180px">
		                </a>
		                            ...
		                            <div class="nav-column nav-column--wide d-none d-lg-block">
		                                <a href="/boys/shirt" class="d-block">
		                                  <img class="d-block w-100 img-fluid lazyload offer-img mt-4 mt-lg-0"
		                                     src="<?php echo get_template_directory_uri(); ?>/img/menu/mm_boys_onecolumn_10px.jpg"
		                                     data-srcset="<?php echo get_template_directory_uri(); ?>/img/menu/mm_boys_onecolumn_medium.jpg 2x,
		                                                  <?php echo get_template_directory_uri(); ?>/img/menu/mm_boys_onecolumn_small.jpg 1x"
